...
> Пожалуйста, не используйте этот плагин для отвратительных поступков, включая, но не ограничиваясь: публикацией фейковых отзывов, размещением рекламы и т.д.
>
...
| `SIM4 [Bots]`              | `Operator` | Получить стикеры [`The Sims™ 4`](https://store.steampowered.com/sale/simscelebrationsale)                                                                                                     |
| `DL2 [Bots]`               | `Operator` | Получить предметы [`Dying Light 2 Stay Human`](https://store.steampowered.com/sale/dyinglight)                                                                                                |
| `DL22 [Bots] [Sticker Id]` | `Operator` | Получить предметы [`Dying Light 2 Stay Human`](https://store.steampowered.com/developer/Techland/sale/techlandsummer2023) , `Sticker Id` не обязателен, значение может быть от 1 до 4         |
| `RLE [Bots] [Sticker Id]`  | `Operator` | Получить предметы [`Redfall Launch Event`](https://store.steampowered.com/sale/redfall_launch) , `Sticker Id` не обязателен, значение может быть от 1 до 4                                    |

## Установка

### Первая установка / Обновление в ручном режиме
 
 1. Загрузите плагин через страницу [GitHub Releases](https://github.com/chr233/ASFEnhance/releases) 
 2. Распакуйте файл `ASFEnhance.dll` и скопируйте его в папку `plugins` в директории `ArchiSteamFarm`
 3. Перезапустите `ArchiSteamFarm` и используйте команду  `ASFE`  для проверки работоспособности плагина

### Команды для обновления
> Для обновления плагина можно использовать собственную команду плагина.
> Обновление версии ASF может быть несовместимым с плагином, если вы обнаружили, что плагин не может быть загружен, попробуйте перезапустить ASF.
...
| [1.8.7.0](https://github.com/chr233/ASFEnhance/releases/tag/1.8.8.0)   |        5.4.8.3         | ASF -> 5.4.8.3, Не совместим с более ранними версиями   |
| [1.8.7.1](https://github.com/chr233/ASFEnhance/releases/tag/1.8.7.1)   |        5.4.7.3         | добавлена команда  `NOTIFICATIONOPTIONS`                |
| [1.8.6.2](https://github.com/chr233/ASFEnhance/releases/tag/1.8.6.2)   |        5.4.7.3         | добавлена команда `DL22`                                |
| [1.8.5.0](https://github.com/chr233/ASFEnhance/releases/tag/1.8.5.0)   |        5.4.7.3         | ASF -> 5.4.7.3, исправления команда  `PURCHASE`         |
...
>
> \*\* Описание `DisabledCmds`: каждый элемент в этой конфигурации является **нечувствительным к командам ASF**, и эта конфигурация влияет только на команды `ASFEnhance`.
...
| `EMAILIOPTIONS [Bots]`                    | `EO`       | `Operator` | Выводит [настройки рассылки](https://store.steampowered.com/account/emailoptout) бота                     |
...
| `NOTIFICATIONOPTIONS [Bots]`              | `NOO`      | `Operator` | Выводит [параметры уведомлений](https://store.steampowered.com/account/notificationsettings) бота         |
...
| `ADVNICKNAME [Bots] Query`             | `ANN`      | `Master`        | Установить использование псевдонима бота в соответствии с `Placeholder`, доступны значения: `%dn%` `%ln%` `%un%` `%botn%` и другие представленные ниже         |
| `SETAVATAR [Bots] ImageUrl` 🐞         | `GA`       | `Opetator`      | Установить аватар бота в соответствии c cсылкой на указанное изображение в Интернете                                                                           |
