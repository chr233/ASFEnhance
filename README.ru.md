...
> Время проведения распродажи 11.22 - 11.29
>
> [Ссылка на магазин](https://store.steampowered.com/steamawards/nominations)

| Команда                | Сокращение | Доступ     | Описание                   |
| ---------------------- | ---------- | ---------- | -------------------------- |
| `VOTE [Bots] <Choose>` | `V`        | `Operator` | Голосование `Steam Awards` |
| `CHECKEVENT [Bots]`    | `CE`       | `Operator` | Получить статус значка     |

> Пример команд, чтобы разблокировать `Значок Осенней Распродажи` (только для справки)

```txt
# Выполнить голоование
VOTE ASF 1245620,1849900,440,1084600,2094190,1332010,1761390,1920660,1718570,2135500,1850570

# Сыграть в одну из понравившихся игр
ADDLICENSE ASF A/440
PLAY ASF 440
RESUME ASF

# Опубликовать отзыв
PUBLISHRECOMMENT ASF 440 [i]Лол[/i]

# Удалить отзыв
DELETERECOMMENT ASF 440

# Проверить состояние значка
CHECKEVENT ASF
```

> Время проведения распродажи 10.19 - ?
>
> [Ссылка на магазин](https://store.steampowered.com/sale/simscelebrationsale?tab=2)
...
| [1.6.18.1](https://github.com/chr233/ASFEnhance/releases/tag/1.6.18.1) | 5.3.2.4                | Обновление ASF               |
| [1.6.18.0](https://github.com/chr233/ASFEnhance/releases/tag/1.6.18.0) | 5.3.1.2                | Добавлена команда `DL2`      |
...
| `Statistic`  | `bool` | `true`       | Разрешить отправку данных для статистики. Она используется для подсчета количества пользователей, никакой другой информации отправляться не будет |
...
| `ASFEHELP`       | `EHELP`    | `FamilySharing` | Показывает список доступных комманд |
| `HELP <Command>` | -          | `FamilySharing` | Помощь по определённой команде      |
