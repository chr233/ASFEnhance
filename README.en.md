...
| `VOTE [Bots] <AppIds>`     | `V`       | `Operator` | STEAM awards, AppIds you can specify up to 10 games. If you do not specify or specify less than 11, the remaining amount will use the built-in AppId for voting.                                                                 |
| `CHECKVOTE [Bots]`         | `CV`      | `Operator` | Get STEAM awards badge task completion status                                                                                                                                            |
